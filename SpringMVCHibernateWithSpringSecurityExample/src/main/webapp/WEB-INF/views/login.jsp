					...
					<div class="login-form">
						...
						<form action="${loginUrl}" method="post" class="form-horizontal">
							...
							<div class="input-group input-sm">
								...
								<input type="text" class="form-control" id="username" name="ssoId" placeholder="Nazwa użytkownika" required>
							</div>
							<div class="input-group input-sm">
							...
							<div class="input-group input-sm">
                              <div class="checkbox">
                                <label><input type="checkbox" id="rememberme" name="remember-me"> Pamiętaj mnie</label>  
                              </div>
                            </div>
